...
const Affordable = () => {
  return (
    <>
        <section id='Affordable' className='mt-[150px] overflow-hidden'>
            <div className="container">
                ...
                <div className='mt-[64px] flex lg:flex-row flex-col items-center justify-center flex-wrap'>
                    <div data-aos="fade-up" className='lg:w-[445px] w-full pr-[40px] pb-[40px] lg:border-r-1 lg:border-b-1 border-[#0b010934]'>
                    ...
                    <div data-aos="fade-up" className='lg:w-[445px] w-full lg:pl-[40px] pb-[40px] lg:border-b-1 border-[#0b010934]'>
                    ...
                    <div data-aos="fade-up" className='lg:w-[445px] w-full pr-[40px] pt-[40px] lg:border-r-1 border-[#0b010934]'>
                    ...
                    <div data-aos="fade-up" className='lg:w-[445px] w-full lg:pl-[40px] pt-[40px]'>
