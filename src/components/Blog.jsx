    ...
    <>
        <section id='Blog' className='mt-[150px]'>
            <div className="container">
                {/* ------------Header-------------- */}
                <div data-aos="fade-up" className='flex lg:flex-row flex-col items-center justify-between'>
                ...
                <div className='mt-[48px] flex lg:flex-row flex-col items-center justify-between'>
                    <div>
                        ...
                        <div data-aos="fade-right" className='flex items-start flex-col mt-[48px]'>
