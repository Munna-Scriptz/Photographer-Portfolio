...
const ContactMe = () => {
  return (
    <>
        <section id="contact" className='lg:mt-0 mt-[80px] overflow-hidden'>
            <div className="container">
                <div id="contactRow">
                    <div className='flex lg:flex-row flex-col items-center gap-[38px]'>
                        <div data-aos="fade-right" className='lg:w-[452px] w-full'>
                            <h2 data-aos="fade-right" className='font-cormorant lg:text-[72px] text-[52px] font-medium leading-[62px] text-secondBK'>I enjoy <span className='TextUnderline italic'>capturing</span> people</h2>
                            <p data-aos="fade-right" className='font-oswald font-semibold text-secondBK text-[24px] mt-[38px] text-end'>-Ellina mary</p>
                ...
                <div className='lg:mt-[150px] mt-[100px] flex lg:flex-row flex-col items-center'>
                    <h2 data-aos="fade-right" className='font-cormorant text-[72px] lg:w-[313px] lg:mb-0 mb-10 font-medium leading-[62px] text-secondBK'>Got many valuable <span className='TextUnderline italic'>awards</span></h2>
                    <div data-aos="fade-up" className='flex lg:flex-row flex-col items-center lg:gap-[60px] gap-10'>
