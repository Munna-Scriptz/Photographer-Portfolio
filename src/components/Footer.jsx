        ...
        <footer className='bg-secondBK w-full mt-[100px] lg:py-[120px] py-[60px] overflow-hidden'>
            <div className='container'>
                <div id="FooterRow" className='flex items-center justify-center flex-col'>
                    <div data-aos="fade-up"><img className='w-[128px]' src={Logo} alt="Logo" /></div>
                    <p data-aos="fade-up" className='font-inter text-base opacity-[0.8] text-white mt-[16px]'>© 2022 Elliana Mary  All Rights Reserved</p>
                    {/* -------------Border Line------------- */}
                    <div data-aos="fade-up" id='FooterBorder' className='relative w-full mt-[47px]'>
